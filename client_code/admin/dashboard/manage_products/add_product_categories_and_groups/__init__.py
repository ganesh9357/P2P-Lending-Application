  ...
  def name_change(self, **event_args):
        ...
        if self.selected_value:
          ...
          if product_categories:
            ...
            self.text_box_1.items = [category['name_categories'] for category in product_categories]
            self.text_box_1.selected_value = product_categories[0]['name_categories'] if product_categories else None
