...
class manage_producs1(manage_producs1Template):
    ...
    def check_box_3_change(self, **event_args):
        ...
        if product_visibility:
            ...
            self.min_amount.visible = True
            self.max_amount.visible = True
            self.max_tenure.visible = True
            self.min_tenure.visible = True
            self.text_box_5.visible = True
            self.radio_button_3.visible = True
            self.radio_button_4.visible = True
            self.emi_paymentt.visible = True
        else:
            ...
            self.min_amount.visible = False
            self.max_amount.visible = False
            self.max_tenure.visible = False
            self.min_tenure.visible = False
            self.text_box_5.visible = False
            self.radio_button_3.visible = False
            self.radio_button_4.visible = False
            self.emi_paymentt.visible = False